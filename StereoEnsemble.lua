...
function StereoEnsemble:onLoadGraph(pUnit,channelCount)
    ...
    if channelCount > 1 then
      ...
      connect(mix1,"Out",pUnit,"Out1")
      connect(mix2,"Out",pUnit,"Out2")
    else 
      connect(pUnit,"In1",delay1,"Left In")
      connect(pUnit,"In1",delay2,"Left In")
      connect(delay1,"Left Out",mix1,"Left")
      connect(delay2,"Left Out",mix1,"Right")
      connect(mix1,"Out",mix2,"Left")
      connect(delay3,"Left Out",mix2,"Right")
      connect(mix2,"Out",dryMix,"Left")
      connect(pUnit,"In1",dryMix,"Right")
...
function StereoEnsemble:onLoadMenu(objects,controls)
...
local function linMap(min,max,n)
  ...
  local rateMap = linMap(0.0,6.0,100)


function StereoEnsemble:onLoadViews(objects,controls)
